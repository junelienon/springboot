...
* The original package name 'new' is invalid and this project uses 'com.example.demo' instead.
...
* [Spring Batch JDBC](https://docs.spring.io/spring-boot/4.0.0-SNAPSHOT/how-to/batch.html)
